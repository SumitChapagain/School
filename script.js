...
function nextSlide() {
    currentSlide = (currentSlide + 1) % facilityItems.length;
    showSlide(currentSlide);
}

function prevSlide() {
    currentSlide = (currentSlide - 1 + facilityItems.length) % facilityItems.length;
    showSlide(currentSlide);
}
...
document.addEventListener('DOMContentLoaded', () => {
    const animatedElements = document.querySelectorAll('.academic-card, .event-card, .stat-item, .grid-item');
...
// Keyboard navigation for facilities slider
...
scrollToTopBtn.addEventListener('mouseenter', () => {
    ...
    scrollToTopBtn.style.background = 'var(--secondary-blue)';
});
